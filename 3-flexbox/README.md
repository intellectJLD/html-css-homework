...
- Создай репозиторий `intellect-markup-hw-03`.
...
- Добавь стили для геометрии (ширины, отступы, поля и рамки) и позиционирование
  ...
  [**домашнего задания #3**](<https://www.figma.com/design/CHJBNEj9jDtHZosTneudua/Web-Studio-(Version-2.1)-(Copy)-(Copy)?node-id=0-1&t=5b55mUbVObDefstg-0>).
