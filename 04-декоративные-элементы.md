...
- Создай репозиторий `intellect-markup-hw-04`.
- Склонируй созданный репозиторий и скопируй в него файлы предыдущей работы.
- Добавь разметку и оформление иконок и декоративных эффектов для страниц из
  макета
  [**домашнего задания #4**](<https://www.figma.com/design/CHJBNEj9jDtHZosTneudua/Web-Studio-(Version-2.1)-(Copy)-(Copy)?node-id=0-1&t=5b55mUbVObDefstg-0>).
