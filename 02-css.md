...
- Создай репозиторий `intellect-markup-hw-02`.
- Склонируй созданный репозиторий и скопируй в него файлы предыдущей работы.
- Выполни разметку и оформление макета страницы
  [**домашнего задания #2**](<https://www.figma.com/design/CHJBNEj9jDtHZosTneudua/Web-Studio-(Version-2.1)-(Copy)-(Copy)?node-id=0-1&t=5b55mUbVObDefstg-0>).
